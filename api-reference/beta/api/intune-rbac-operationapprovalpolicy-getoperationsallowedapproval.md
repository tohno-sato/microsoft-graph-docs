---
title: "getOperationsAllowedApproval function"
...
# getOperationsAllowedApproval function
...
``` http
GET https://graph.microsoft.com/beta/deviceManagement/operationApprovalPolicies/getOperationsAllowedApproval
```
