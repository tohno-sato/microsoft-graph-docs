...
## Response
If successful, this method returns a `200 OK` response code and [appleExpeditedCheckinConfigurationBase](../resources/intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md) object in the response body.
