...
# Create deviceEnrollmentNotificationConfiguration
...
## Request body
In the request body, supply a JSON representation for the deviceEnrollmentNotificationConfiguration object.

The following table shows the properties that are required when you create the deviceEnrollmentNotificationConfiguration.
...
## Response
If successful, this method returns a `201 Created` response code and a [deviceEnrollmentNotificationConfiguration](../resources/intune-onboarding-deviceenrollmentnotificationconfiguration.md) object in the response body.
