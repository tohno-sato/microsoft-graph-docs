...
description: "List properties and relationships of the windowsFeatureUpdateCatalogItem objects."
author: "jaiprakashmb"
...
## Response
If successful, this method returns a `200 OK` response code and a collection of [windowsFeatureUpdateCatalogItem](../resources/intune-softwareupdate-windowsfeatureupdatecatalogitem.md) objects in the response body.
