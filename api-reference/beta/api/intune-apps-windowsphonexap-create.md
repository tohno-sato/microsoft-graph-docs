...
## Request body
In the request body, supply a JSON representation for the windowsPhoneXAP object.

The following table shows the properties that are required when you create the windowsPhoneXAP.
...
## Response
If successful, this method returns a `201 Created` response code and a [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) object in the response body.
