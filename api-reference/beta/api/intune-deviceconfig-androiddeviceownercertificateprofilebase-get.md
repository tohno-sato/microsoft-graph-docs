...
## Response
If successful, this method returns a `200 OK` response code and [androidDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-androiddeviceownercertificateprofilebase.md) object in the response body.
